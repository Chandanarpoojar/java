...
public Compney(int price){
this(500000,"gogel");
System.out.println("the  constructor with price ="+price);
}
public Compney(int num,String name){
...
public Compney(int employeenumber, String compneyName,float rateing ){
	this(true,6.6,'A',"ibm");
System.out.println("this is a constructor rateing="+rateing);
System.out.println("this is constructor price="+employeenumber);
System.out.println("this is constructor compneyName="+compneyName);
}
public Compney(boolean isGood,double reveiw,char grade,String name){
...
public Compney(int ammount,float reveiw,boolean isBad,char grade,String brandName,double rateing,long number){
