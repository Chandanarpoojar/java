...
System.out.println("ammount="+num);
System.out.println("name="+name);
}
public Student(int id,boolean isGood,String name){
...
public Student(double hight,float wight,long number,int id){
...
public Student(int id,float distence,char grade,boolean isGood,String area){
...
public Student(int numid,float hights,char grade,double distence,String name,boolean isBad,long number){
