class BedRunner
{
	public static void main(String[] ref)
	{
        ...
        float[] bedWeights = Bed.bedWeights(weights);
        ...
        char[] grades = {'A', 'B', 'A', 'C'};
        char[] bedGrades = Bed.qualityGrades(grades);
        ...
        String[] bedTypes = Bed.bedTypes(types);
        ...
        long[] bedSerials = Bed.serialNumbers(serials);
